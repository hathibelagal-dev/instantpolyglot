...
SAE languages often use similar affixes for derivation:
...
Many SAE languages use particles or prefixes to modify verb meanings:
...
Many SAE languages use similar politeness strategies:
