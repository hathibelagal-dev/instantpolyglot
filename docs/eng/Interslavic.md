...
Future tense is formed using the infinitive and the future tense of **byti**:
...
Interslavic uses different structures for different types of conditional sentences:
