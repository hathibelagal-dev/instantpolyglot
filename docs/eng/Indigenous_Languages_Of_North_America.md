...
Example: In Central Pomo (Pomoan):
...
Example: In Lakhota (Siouan), the word for “heart” is used metaphorically:
- **čhaŋté** “heart”
...
Example: Michif, a mixed language combining Cree (Algonquian) verbs with French nouns:
