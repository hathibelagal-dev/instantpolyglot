...
| Ф ф | /f/ | Voiceless labiodental fricative |
...
Rusyn uses impersonal constructions for various purposes:
...
- **Няй ся стане!** (Niai sia stane!, 'Let it be so!', expressing agreement or resignation)
