...
Finnish has an impersonal passive:
...
Yes/no questions are formed by adding the particle **-ko/-kö** to the first word:
...
Each group has its own distinctive features in phonology, morphology, and vocabulary.
