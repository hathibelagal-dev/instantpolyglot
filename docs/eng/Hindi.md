...
| श | /ʃ/ | voiceless palato-alveolar fricative |
...
However, due to the case system, word order can be flexible for emphasis or style.
...
1. Simplified verb conjugations:
...
Hindi uses various participles:
